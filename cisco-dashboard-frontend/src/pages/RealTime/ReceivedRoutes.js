// src/pages/RealTime/ReceivedRoutes.js
...
function ReceivedRoutes() {
  ...
  const apiUrl = activeIp ? `/api/routes/received/${activeIp}` : null;
  ...
  return (
    <div style={{ padding: '1rem' }}>
      ...
      <h1>Received Routes {activeIp && <span style={{ fontSize: '1rem', color: '#666' }}>({activeIp})</span>}</h1>
      ...
      {isLoading && <LoadingSpinner message="Fetching received routes..." />}
